...
const Projects = () => {
  ...
  const projects = [
    { id: 1, title: 'Full Stack E-commerce', category: 'MERN Stack', image: project1, year: '2024' },
    { id: 2, title: 'SaaS Dashboard', category: 'Next.js', image: project2, year: '2024' },
    { id: 3, title: 'Real-time Chat App', category: 'MERN Stack', image: project3, year: '2023' },
    { id: 4, title: 'Personal Portfolio', category: 'React & GSAP', image: project4, year: '2023' },
    { id: 5, title: 'Auth System', category: 'Next.js', image: project1, year: '2023' },
    { id: 6, title: 'Inventory Management', category: 'MySQL', image: project2, year: '2022' },
  ];

  const filters = ['All', 'MERN Stack', 'Next.js', 'React & GSAP', 'MySQL'];
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
            {filters.map((filter) => (
              <button key={filter} onClick={() => setActiveFilter(filter)}
                className={`filter-btn px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-full text-xs sm:text-sm font-medium transition-all duration-500 relative overflow-hidden group ${activeFilter === filter ? 'text-primary-foreground glow-cyan' : 'text-muted-foreground hover:text-foreground'
                  }`}
