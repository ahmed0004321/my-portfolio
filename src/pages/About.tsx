...
const About = () => {
  ...
  const skills = [
    ...
    { name: 'JavaScript & C++', level: 85 },
    { name: 'Tailwind CSS & UI Design', level: 95 },
  ];

  const timeline = [
    { year: '2024 - Present', title: 'Student & Developer', company: 'Prime University', description: 'Deepening knowledge in Computer Science and building full-stack applications.' },
    { year: '2023 - 2024', title: 'Full Stack Learning Journey', company: 'Self-Taught', description: 'Mastered React, Node.js, and modern web technologies through rigorous projects.' },
    { year: 'Earlier', title: 'Problem Solving', company: 'Competitive Programming', description: 'Started with C++ and logic building.' },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
            <div style={{ perspective: '1000px' }}>
              ...
              <p className="about-hero-desc text-sm sm:text-lg md:text-xl leading-relaxed font-light text-muted-foreground mb-4 sm:mb-6">
                I am a passionate Full Stack Developer currently studying at Prime University.
                With 1 year of hands-on experience in building modern web applications, I specialize in the MERN stack and Next.js.
              </p>
              <p className="about-hero-desc text-sm sm:text-base text-muted-foreground">
                I believe in combining clean code with seamless user experiences to build impactful digital solutions.
              </p>
            </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              { number: 4, label: 'Awards Won', suffix: '' },
            ].map((stat, i) => (
