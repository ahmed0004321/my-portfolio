    ...
    <footer className="border-t border-border" style={{ background: 'hsl(220 15% 5%)' }}>
      ...
      <div className="container-custom py-6 sm:py-8 border-t border-border">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-8">
            <a href="mailto:ahmed0004321@gmail.com" className="text-muted-foreground hover:text-primary transition-colors text-xs sm:text-sm">
              ahmed0004321@gmail.com
            </a>
            <div className="flex gap-3 sm:gap-4">
              {[
                ...
                <a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-xs sm:text-sm hover:drop-shadow-[0_0_6px_hsla(187,100%,50%,0.4)]">
                  {social.name}
                </a>
              ))}
            </div>
